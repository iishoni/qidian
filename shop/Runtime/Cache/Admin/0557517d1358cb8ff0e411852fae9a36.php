...
<head>
    ...
    <link rel="apple-touch-icon" type="image/x-icon" href="/lyadminmy/favicon.ico">
    <link rel="shortcut icon" type="image/x-icon" href="/lyadminmy/logo.png">
    <link rel="stylesheet" type="text/css" href="http://localhost/lyadminmy/Public/libs/lyui/dist/css/lyui.min.css">
    <link rel="stylesheet" type="text/css" href="http://localhost/lyadminmy/shop/Admin/View/Public/css/admin.css">
    ...
    <![endif]-->
    <script type="text/javascript" src="http://localhost/lyadminmy/Public/libs/jquery/1.x/jquery.min.js"></script>
</head>
<body class="<?php echo ($_page_name); ?>">
    ...
    <div class="clearfix full-script">
        <div class="container-fluid">
            <input type="hidden" id="corethink_home_img" value="http://localhost/lyadminmy/shop/Home/View/Public/img">
            <script type="text/javascript" src="http://localhost/lyadminmy/Public/libs/lyui/dist/js/lyui.min.js"></script>
            <script type="text/javascript" src="http://localhost/lyadminmy/shop/Admin/View/Public/js/admin.js"></script>
